...
CHECKPOINT_PATH="/nobackup/users/brytech/train_uld_run_codesearchnet/output_weights/codellama_lora/checkpoint-3/adapter_model.safetensors"  # Path to checkpoint
