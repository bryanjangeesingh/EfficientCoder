...
STUDENT_NAME="codeparrot/codeparrot-small"       # Replace with your student model
...
SAVE_DIR="/nobackup/users/brytech/train_uld_run_codesearchnet/output_weights/codeparrot_lora_and_uld"    # Directory to save model weights
CHECKPOINT_PATH=""
START_CHECKPOINT="0"
